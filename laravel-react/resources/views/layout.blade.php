...
<body>
    ...
    <div class="containerfull">
        <img src="/resources/views/images/banner.webp" alt="">
    </div>
    ...
    <div class="row">
        <div class="boxnews mr2pt">
            <img src="/resources/views/images/hinh2.webp" alt="">
            <p>11/03/2022</p>
        ...
        <div class="boxnews mr2pt">
            <img src="/resources/views/images/hinh6.jpg" alt="">
            <p>11/03/2022</p>
        ...
        <div class="boxnews mr2pt">
            <img src="/resources/views/images/hinh3.jpg" alt="">
            <p>11/03/2022</p>
    ...
    <div class="row">
        <div class="boxnews mr2pt">
            <img src="/resources/views/images/hinh7.jpg" alt="">
            <p>11/03/2022</p>
            <p><a href="#">CÁCH NHẬN BIẾT HƯƠNG VỊ CÀ PHÊ</a></p>
            <p>Cùng Arabica, Robusta cũng là loại cà phê nổi tiếng được sử dụng phổ biến ở Việt Nam và nhiều nước khác trên thế giới. Với nhiều đặc điểm riêng, không...</p>
        </div>
        <div class="boxnews mr2pt">
            <img src="/resources/views/images/hinh5.jpg" alt="">
            <p>11/03/2022</p>
        ...
        <div class="boxnews mr2pt">
            <img src="/resources/views/images/hinh4.jpg" alt="">
            <p>11/03/2022</p>
