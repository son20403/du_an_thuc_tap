        ...
        <tr>
            <td>
                <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td>
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        font-family:'Rubik',sans-serif;">{{ $details['title'] }}</h1>
                                        <span
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>Ashion shop</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
