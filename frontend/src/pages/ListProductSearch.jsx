    ...
    return (
        <div className="col-lg-4 col-md-6">
            <div className="product__item">
                <div className="product__item__pic set-bg" data-setbg={product.anh_sp}>
                    <div className="label new">New</div>
                    <ul className="product__hover">
                        <li><a href={product.anh_sp} className="image-popup">
                            <span className="arrow_expand" /></a></li>
                        <li><Link to={`/detail/${product.slug}`}><span className="icon_bag_alt" /></Link></li>
                    </ul>
                </div>
